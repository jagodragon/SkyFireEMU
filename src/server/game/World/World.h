...
public:
    ...
    time_t GetGuildAdvancementDailyXPResetTime() const {
        return m_NextHourlyXPReset;
    }
    ...
    uint32 const GetShutDownTimeLeft() {
    ...
    void DeleteCharaceterNameData(uint32 guid) {
        _characterNameDataMap.erase(guid);
    }
